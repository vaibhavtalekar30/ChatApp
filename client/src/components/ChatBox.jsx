        ...
        {messages.map((m) => {
          ...
          return (
            ...
            >
              ...
              {/* Message Bubble */}
              <div
                className={`px-4 py-2 rounded-2xl max-w-xs md:max-w-md break-words text-sm shadow
          ${isMe
                    ? "bg-blue-400 text-black rounded-br-sm"
              ...
              {/* Seen Indicator BELOW message */}
              {isMe && (
                <span
                  className={`text-xs mt-1 ${m.seen ? "text-green-600" : "text-gray-400"
                    }`}
                >
                  {m.seen ? "Seen" : "Sent"}
                </span>
